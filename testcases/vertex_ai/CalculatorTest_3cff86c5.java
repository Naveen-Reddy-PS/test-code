...
public class CalculatorTest {
    ...
    public void testCalculatePercentage_resultExceedsMax() {
        calculator.calculatePercentage(1000000, 1000);
    }
    ...
    public void testCalculatePercentage_largeValueAndPercentage() {
        assertEquals(50000.0, calculator.calculatePercentage(10000, 50), 0.001);
    }
    ...
    /**
     * Test case for calculatePercentage with negative value and negative percentage.
     */
    @Test
    public void testCalculatePercentage_negativeValueAndPercentage() {
        assertEquals(25.0, calculator.calculatePercentage(-100, -25), 0.001);
    }
}