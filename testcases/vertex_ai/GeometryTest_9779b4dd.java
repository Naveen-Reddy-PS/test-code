...
class GeometryTest {
    ...
    void calculateCircleArea_positiveRadius_returnsCorrectArea() {
        ...
        assertEquals(expectedArea, geometry.calculateCircleArea(radius), 0.0001);
    }
    ...
    void calculateRectangleArea_positiveLengthWidth_returnsCorrectArea() {
        ...
        assertEquals(expectedArea, geometry.calculateRectangleArea(length, width), 0.0001);
    }
    ...
    void calculateTriangleArea_positiveBaseHeight_returnsCorrectArea() {
        ...
        assertEquals(expectedArea, geometry.calculateTriangleArea(base, height), 0.0001);
    }
    ...
    void calculateCirclePerimeter_positiveRadius_returnsCorrectPerimeter() {
        ...
        assertEquals(expectedPerimeter, geometry.calculateCirclePerimeter(radius), 0.0001);
    }
    ...
    void calculateRectanglePerimeter_positiveLengthWidth_returnsCorrectPerimeter() {
        ...
        assertEquals(expectedPerimeter, geometry.calculateRectanglePerimeter(length, width), 0.0001);
    }
    ...
    void calculateDistance_positiveCoordinates_returnsCorrectDistance() {
        ...
        assertEquals(expectedDistance, geometry.calculateDistance(x1, y1, x2, y2), 0.0001);
    }
