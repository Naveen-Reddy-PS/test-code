...
class GeometryTest {
    ...
    @Test
    void calculateRectangleArea_largeDimensions() {
        Geometry geometry = new Geometry();
        double length = 100.0;
        double width = 200.0;
        double expectedArea = length * width;
    ...
    @Test
    void calculateRectangleArea_bothDimensionsNegative_throwsException() {
        Geometry geometry = new Geometry();
        double length = -5.0;
        double width = -10.0;
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> geometry.calculateRectangleArea(length, width));
    ...
    @Test
    void calculateTriangleArea_largeDimensions() {
        Geometry geometry = new Geometry();
        double base = 100.0;
        double height = 200.0;
        double expectedArea = 0.5 * base * height;
    ...
    @Test
    void calculateTriangleArea_bothDimensionsNegative_throwsException() {
        Geometry geometry = new Geometry();
        double base = -5.0;
        double height = -10.0;
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> geometry.calculateTriangleArea(base, height));
    ...
    @Test
    void calculateRectanglePerimeter_largeDimensions() {
        Geometry geometry = new Geometry();
        double length = 100.0;
        double width = 200.0;
        double expectedPerimeter = 2 * (length + width);
    ...
    @Test
    void calculateRectanglePerimeter_bothDimensionsNegative_throwsException() {
        Geometry geometry = new Geometry();
        double length = -5.0;
        double width = -10.0;
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> geometry.calculateRectanglePerimeter(length, width));
    ...
    @Test
    void calculateDistance_sameXCoordinates() {
        Geometry geometry = new Geometry();
        double x1 = 5.0;
        double y1 = 2.0;
        double x2 = 5.0;
        double y2 = 6.0;
        double expectedDistance = Math.abs(y2 - y1);
        assertEquals(expectedDistance, geometry.calculateDistance(x1, y1, x2, y2), 0.001);
    }

    @Test
    void calculateDistance_sameYCoordinates() {
        Geometry geometry = new Geometry();
        double x1 = 1.0;
        double y1 = 5.0;
        double x2 = 4.0;
        double y2 = 5.0;
        double expectedDistance = Math.abs(x2 - x1);
        assertEquals(expectedDistance, geometry.calculateDistance(x1, y1, x2, y2), 0.001);
    }
}