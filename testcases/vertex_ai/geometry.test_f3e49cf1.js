...
describe('calculateRectangleArea', () => {
    ...
    /** */
     ...
     // /
    test('should calculate the area of a rectangle with one dimension as zero', () => {
    ...
    /** */
     ...
     // /
    test('should calculate the area of a rectangle with both dimensions as zero', () => {
...
describe('calculateTriangleArea', () => {
    ...
    /** */
     ...
     // /
    test('should calculate the area of a triangle with one dimension as zero', () => {
    ...
    /** */
     ...
     // /
    test('should calculate the area of a triangle with both dimensions as zero', () => {
...
describe('calculateRectanglePerimeter', () => {
    ...
    /** */
     ...
     // /
    test('should calculate the perimeter of a rectangle with one dimension as zero', () => {
    ...
    /** */
     ...
     // /
    test('should calculate the perimeter of a rectangle with both dimensions as zero', () => {
