...
class CalculatorTest {
    ...
    void calculatePercentage_decimalValueAndPercentage_returnsCorrectPercentage() {
        assertEquals(12.625, calculator.calculatePercentage(50.5, 25.0));
    }

    @Test
    void calculatePercentage_maxValue_returnsCorrectPercentage() {
        double value = 999999.0;
        double percentage = 99.0;
        double expectedResult = (value * percentage) / 100;
